...
#include <linux/tls.h>
#include <net/tcp.h>
# 5 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_transport_tcp.c.patch"
# 26 "/scrap/drbd/drbd/drbd_transport_tcp.c"
#include <net/handshake.h>
#include <net/tls.h>
# 8 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_transport_tcp.c.patch"
...
# 15 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_transport_tcp.c.patch"
# 291 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_transport_tcp.c"
...
# 53 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_transport_tcp.c.patch"
# 284 "/scrap/drbd/drbd/drbd_transport_tcp.c"
...
# 740 "/scrap/drbd/drbd/drbd_transport_tcp.c"
# 61 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_transport_tcp.c.patch"
# 789 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_transport_tcp.c"
	timeo += (prandom_u32() % 2) ? timeo / 7 : -timeo / 7; /* 28.5% random jitter */
# 62 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_transport_tcp.c.patch"
# 740 "/scrap/drbd/drbd/drbd_transport_tcp.c"
...
retry:
		...
		if (s) {
			...
			default:
				...
				dtt_socket_free(&s);
randomize:
# 1274 "/scrap/drbd/drbd/drbd_transport_tcp.c"
# 70 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_transport_tcp.c.patch"
# 1328 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_transport_tcp.c"
				if ((prandom_u32() % 2))
# 71 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_transport_tcp.c.patch"
# 1274 "/scrap/drbd/drbd/drbd_transport_tcp.c"
					goto retry;
			}
		}
...
# 81 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_transport_tcp.c.patch"
...
# 90 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_transport_tcp.c.patch"
# 1554 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_transport_tcp.c"
	struct msghdr msg = { .msg_flags = msg_flags | MSG_NOSIGNAL };
# 91 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_transport_tcp.c.patch"
# 1497 "/scrap/drbd/drbd/drbd_transport_tcp.c"
	int len = size;
	int err = -EIO;
...
# 102 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_transport_tcp.c.patch"
# 1570 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_transport_tcp.c"
		sent = socket->ops->sendpage(socket, page, offset, len,
					     msg.msg_flags);
# 104 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_transport_tcp.c.patch"
# 1511 "/scrap/drbd/drbd/drbd_transport_tcp.c"
		if (sent <= 0) {
			if (sent == -EAGAIN) {
				if (drbd_stream_send_timed_out(transport, stream))
