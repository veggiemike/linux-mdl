			 ...
			 struct page *caller_page, int offset, size_t size, unsigned int msg_flags)
{
	...
	if (msg_flags & MSG_SPLICE_PAGES) {
		...
		if (!page) {
			kfree(tx_desc);
# 5 "/scrap/drbd/drbd/build-6.18.44-mdl+/.patches/drbd_transport_rdma.c.patch"
# 3186 "/scrap/drbd/drbd/drbd_transport_rdma.c"
			return -ENOMEM;
		}
# 3189 "/scrap/drbd/drbd/drbd_transport_rdma.c"
# 8 "/scrap/drbd/drbd/build-6.18.44-mdl+/.patches/drbd_transport_rdma.c.patch"
# 3194 "/scrap/drbd/drbd/build-6.18.44-mdl+/drbd_transport_rdma.c"
		from = kmap(caller_page);
# 9 "/scrap/drbd/drbd/build-6.18.44-mdl+/.patches/drbd_transport_rdma.c.patch"
# 3189 "/scrap/drbd/drbd/drbd_transport_rdma.c"
		memcpy(page_address(page), from + offset, size);
# 3191 "/scrap/drbd/drbd/drbd_transport_rdma.c"
# 11 "/scrap/drbd/drbd/build-6.18.44-mdl+/.patches/drbd_transport_rdma.c.patch"
# 3201 "/scrap/drbd/drbd/build-6.18.44-mdl+/drbd_transport_rdma.c"
		kunmap(caller_page);
# 12 "/scrap/drbd/drbd/build-6.18.44-mdl+/.patches/drbd_transport_rdma.c.patch"
# 3191 "/scrap/drbd/drbd/drbd_transport_rdma.c"
		offset = 0;
	}
