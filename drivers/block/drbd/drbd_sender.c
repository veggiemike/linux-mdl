...
# 5 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_sender.c.patch"
# 324 "/scrap/drbd/drbd/drbd_sender.c"
	/* to avoid recursion in __req_mod */
	if (unlikely(status)) {
# 327 "/scrap/drbd/drbd/drbd_sender.c"
# 8 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_sender.c.patch"
# 332 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_sender.c"
		unsigned int op = bio_op(bio);
# 9 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_sender.c.patch"
# 327 "/scrap/drbd/drbd/drbd_sender.c"
