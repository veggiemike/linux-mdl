...
# 5 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 55 "/scrap/drbd/drbd/drbd_main.c"
#include "drbd_dax_pmem.h"

# 59 "/scrap/drbd/drbd/drbd_main.c"
# 9 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 63 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
static int drbd_open(struct block_device *bdev, fmode_t mode);
static void drbd_release(struct gendisk *gd, fmode_t mode);
# 11 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 59 "/scrap/drbd/drbd/drbd_main.c"
...
# 1604 "/scrap/drbd/drbd/drbd_main.c"
# 19 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 1614 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
		p->qlim->discard_enabled = !!bdev_get_queue(bdev)->limits.max_discard_sectors;
# 20 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 1604 "/scrap/drbd/drbd/drbd_main.c"
...
# 2356 "/scrap/drbd/drbd/drbd_main.c"
# 28 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2371 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
	const unsigned int op = bio_op(req->master_bio);
# 29 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2356 "/scrap/drbd/drbd/drbd_main.c"
 ...
 */
# 2671 "/scrap/drbd/drbd/drbd_main.c"
# 37 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2691 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
static enum ioc_rv inc_open_count(struct drbd_device *device, fmode_t mode)
# 38 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2671 "/scrap/drbd/drbd/drbd_main.c"
{
	struct drbd_resource *resource = device->resource;
	enum ioc_rv r;
	...
	if (test_bit(UNREGISTERED, &device->flags))
		...
		resource->role[NOW] != R_PRIMARY &&
# 2685 "/scrap/drbd/drbd/drbd_main.c"
# 47 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2709 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
		(device->open_cnt == 0 || mode & FMODE_WRITE)) {
		if (mode & FMODE_NDELAY)
# 49 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2685 "/scrap/drbd/drbd/drbd_main.c"
			r = IOC_ABORT;
		else
			r = IOC_SLEEP;
		...
		r = IOC_OK;
		device->open_cnt++;
# 2692 "/scrap/drbd/drbd/drbd_main.c"
# 56 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2722 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
		if (mode & FMODE_WRITE)
# 57 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2692 "/scrap/drbd/drbd/drbd_main.c"
...
# 2767 "/scrap/drbd/drbd/drbd_main.c"
# 65 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2802 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
static int drbd_open(struct block_device *bdev, fmode_t mode)
# 66 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2767 "/scrap/drbd/drbd/drbd_main.c"
{
# 2769 "/scrap/drbd/drbd/drbd_main.c"
# 68 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2809 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
	struct drbd_device *device = bdev->bd_disk->private_data;
# 69 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2769 "/scrap/drbd/drbd/drbd_main.c"
	struct drbd_resource *resource = device->resource;
...
# 2778 "/scrap/drbd/drbd/drbd_main.c"
# 77 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2823 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
	if (!(mode & FMODE_WRITE) && !drbd_allow_oos) {
# 78 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2778 "/scrap/drbd/drbd/drbd_main.c"
		char comm[TASK_COMM_LEN];
...
# 2787 "/scrap/drbd/drbd/drbd_main.c"
# 86 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2837 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
	if (bdev_read_only(bdev) && (mode & FMODE_WRITE))
# 87 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2787 "/scrap/drbd/drbd/drbd_main.c"
		return -EACCES;
...
# 2816 "/scrap/drbd/drbd/drbd_main.c"
# 95 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2871 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
		if (mode & FMODE_WRITE) {
# 96 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2816 "/scrap/drbd/drbd/drbd_main.c"
			if (resource->role[NOW] == R_SECONDARY) {
# 2818 "/scrap/drbd/drbd/drbd_main.c"
# 98 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2878 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
				rv = try_to_promote(device, timeout,
						    (mode & FMODE_NDELAY));
# 100 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2818 "/scrap/drbd/drbd/drbd_main.c"
				if (rv < SS_SUCCESS)
					drbd_info(resource, "Auto-promote failed: %s (%d)\n",
						  drbd_set_st_err_str(rv), rv);
			}
# 2823 "/scrap/drbd/drbd/drbd_main.c"
# 105 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2889 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
		} else if ((mode & FMODE_NDELAY) == 0) {
# 106 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2823 "/scrap/drbd/drbd/drbd_main.c"
			/* Double check peers
			 *
...
# 2843 "/scrap/drbd/drbd/drbd_main.c"
# 114 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2914 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
			!(mode & FMODE_WRITE) && !drbd_allow_oos) {
# 115 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2843 "/scrap/drbd/drbd/drbd_main.c"
		err = -EMEDIUMTYPE;
		goto out;
	}
...
# 122 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2926 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
	} else if (mode & FMODE_WRITE) {
# 123 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2850 "/scrap/drbd/drbd/drbd_main.c"
		if (resource->role[NOW] != R_PRIMARY)
...
out:
	...
	mutex_unlock(&resource->open_release);
	if (err) {
# 2875 "/scrap/drbd/drbd/drbd_main.c"
# 132 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2955 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
		drbd_release(bdev->bd_disk, 0);
		if (err == -EAGAIN && !(mode & FMODE_NDELAY))
# 134 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2875 "/scrap/drbd/drbd/drbd_main.c"
			err = -EMEDIUMTYPE;
	}
...
# 2956 "/scrap/drbd/drbd/drbd_main.c"
# 142 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 3042 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
static void drbd_release(struct gendisk *gd, fmode_t mode)
# 143 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 2956 "/scrap/drbd/drbd/drbd_main.c"
{
...
# 3270 "/scrap/drbd/drbd/drbd_main.c"
# 151 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 3361 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
	blk_cleanup_disk(device->vdisk);
# 152 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 3270 "/scrap/drbd/drbd/drbd_main.c"
				      ...
				      struct device_conf *device_conf, struct drbd_device **p_device)
{
	...
	bool locked = false;
# 164 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
...
# 174 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 4223 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
	disk = blk_alloc_disk(NUMA_NO_NODE);
	if (!disk) {
# 176 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 4132 "/scrap/drbd/drbd/drbd_main.c"
		goto out_no_disk;
	}
...
# 183 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 4245 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
	blk_queue_flag_set(QUEUE_FLAG_STABLE_WRITES, disk->queue);
	blk_queue_write_cache(disk->queue, true, true);
# 185 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 4147 "/scrap/drbd/drbd/drbd_main.c"
...
out_no_bitmap:
	__free_page(device->md_io.page);
out_no_io_page:
# 4286 "/scrap/drbd/drbd/drbd_main.c"
# 193 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 4390 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
	blk_cleanup_disk(disk);
# 194 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 4286 "/scrap/drbd/drbd/drbd_main.c"
out_no_disk:
	kref_put(&resource->kref, drbd_destroy_resource);
	kref_debug_put(&resource->kref_debug, 4);
...
void drbd_unregister_device(struct drbd_device *device)
{
	...
	destroy_workqueue(device->submit.wq);
	device->submit.wq = NULL;
# 4330 "/scrap/drbd/drbd/drbd_main.c"
# 202 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 4439 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
	del_timer_sync(&device->request_timer);
# 203 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 4330 "/scrap/drbd/drbd/drbd_main.c"
}
...
{
# 4352 "/scrap/drbd/drbd/drbd_main.c"
# 211 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 4466 "/scrap/drbd/drbd/build-5.15.180-mdl+/drbd_main.c"
	if (del_timer_sync(&connection->connect_timer)) {
# 212 "/scrap/drbd/drbd/build-5.15.180-mdl+/.patches/drbd_main.c.patch"
# 4352 "/scrap/drbd/drbd/drbd_main.c"
