...
# 5 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 55 "/scrap/drbd/drbd/drbd_main.c"
#include "drbd_dax_pmem.h"

# 59 "/scrap/drbd/drbd/drbd_main.c"
# 9 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 61 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
static int drbd_open(struct block_device *bdev, fmode_t mode);
static void drbd_release(struct gendisk *gd, fmode_t mode);
# 11 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 59 "/scrap/drbd/drbd/drbd_main.c"
...
# 1596 "/scrap/drbd/drbd/drbd_main.c"
# 19 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 1606 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
		p->qlim->discard_enabled = !!bdev_get_queue(bdev)->limits.max_discard_sectors;
# 20 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 1596 "/scrap/drbd/drbd/drbd_main.c"
...
# 2348 "/scrap/drbd/drbd/drbd_main.c"
# 28 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2363 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
	const unsigned int op = bio_op(req->master_bio);
# 29 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2348 "/scrap/drbd/drbd/drbd_main.c"
...
# 37 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2673 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
static enum ioc_rv inc_open_count(struct drbd_device *device, fmode_t mode)
# 38 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2653 "/scrap/drbd/drbd/drbd_main.c"
{
	struct drbd_resource *resource = device->resource;
# 2656 "/scrap/drbd/drbd/drbd_main.c"
# 41 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2679 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
	enum ioc_rv r = mode & FMODE_NDELAY ? IOC_ABORT : IOC_SLEEP;
# 42 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2656 "/scrap/drbd/drbd/drbd_main.c"
...
# 50 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2697 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
		if (mode & FMODE_WRITE)
# 51 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2667 "/scrap/drbd/drbd/drbd_main.c"
...
# 59 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2777 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
static int drbd_open(struct block_device *bdev, fmode_t mode)
# 60 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2742 "/scrap/drbd/drbd/drbd_main.c"
{
# 2744 "/scrap/drbd/drbd/drbd_main.c"
# 62 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2782 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
	struct drbd_device *device = bdev->bd_disk->private_data;
# 63 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2744 "/scrap/drbd/drbd/drbd_main.c"
	struct drbd_resource *resource = device->resource;
...
# 71 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2798 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
	if (!(mode & FMODE_WRITE) && !drbd_allow_oos) {
# 72 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2753 "/scrap/drbd/drbd/drbd_main.c"
		char comm[TASK_COMM_LEN];
...
# 80 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2812 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
	if (bdev_read_only(bdev) && (mode & FMODE_WRITE))
# 81 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2762 "/scrap/drbd/drbd/drbd_main.c"
		return -EACCES;
...
# 89 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2846 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
		if (mode & FMODE_WRITE) {
# 90 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2791 "/scrap/drbd/drbd/drbd_main.c"
			if (resource->role[NOW] == R_SECONDARY) {
# 2793 "/scrap/drbd/drbd/drbd_main.c"
# 92 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2851 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
				rv = try_to_promote(device, timeout,
						    (mode & FMODE_NDELAY));
# 94 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2793 "/scrap/drbd/drbd/drbd_main.c"
				if (rv < SS_SUCCESS)
...
# 99 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2860 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
		} else if ((mode & FMODE_NDELAY) == 0) {
# 100 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2798 "/scrap/drbd/drbd/drbd_main.c"
			/* Double check peers
			 *
...
# 108 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2889 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
			!(mode & FMODE_WRITE) && !drbd_allow_oos) {
# 109 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2818 "/scrap/drbd/drbd/drbd_main.c"
		err = -EMEDIUMTYPE;
		goto out;
	}
...
# 116 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2899 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
	} else if (mode & FMODE_WRITE) {
# 117 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2825 "/scrap/drbd/drbd/drbd_main.c"
		if (resource->role[NOW] != R_PRIMARY)
...
# 126 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2930 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
		drbd_release(bdev->bd_disk, 0);
		if (err == -EAGAIN && !(mode & FMODE_NDELAY))
# 128 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2850 "/scrap/drbd/drbd/drbd_main.c"
			err = -EMEDIUMTYPE;
	}
...
# 136 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 3017 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
static void drbd_release(struct gendisk *gd, fmode_t mode)
# 137 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 2931 "/scrap/drbd/drbd/drbd_main.c"
{
...
# 3246 "/scrap/drbd/drbd/drbd_main.c"
# 145 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 3337 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
	blk_cleanup_disk(device->vdisk);
# 146 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 3246 "/scrap/drbd/drbd/drbd_main.c"
...
# 156 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 4195 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
	disk = blk_alloc_disk(NUMA_NO_NODE);
	if (!disk) {
# 158 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 4101 "/scrap/drbd/drbd/drbd_main.c"
		goto out_no_disk;
	}
...
out_no_bitmap:
	__free_page(device->md_io.page);
out_no_io_page:
# 4258 "/scrap/drbd/drbd/drbd_main.c"
# 166 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 4358 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
	blk_cleanup_disk(disk);
# 167 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 4258 "/scrap/drbd/drbd/drbd_main.c"
out_no_disk:
	kref_put(&resource->kref, drbd_destroy_resource);
	kref_debug_put(&resource->kref_debug, 4);
...
# 175 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 4406 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
	del_timer_sync(&device->request_timer);
# 176 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 4301 "/scrap/drbd/drbd/drbd_main.c"
}
...
# 184 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 4433 "/scrap/drbd/drbd/build-5.15.167-mdl+/drbd_main.c"
	if (del_timer_sync(&connection->connect_timer)) {
# 185 "/scrap/drbd/drbd/build-5.15.167-mdl+/.patches/drbd_main.c.patch"
# 4323 "/scrap/drbd/drbd/drbd_main.c"
